...
const Modal = ({ isOpen, onClick, onClose, message, message2 }) => {
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-[#191919]">
              ...
              <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-white dark:text-white">
                  {`${message}?`}
                </h3>
                <button
                  onClick={onClick}
                ...
                >
                  {`${message2 ? message2 : " Yes, I'm sure"}`}
                </button>
                <button
                  onClick={onClose}
                  data-modal-hide="popup-modal"
                  type="button"
                  className="py-2.5 px-5 ms-3 text-sm font-medium text-white focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                >
                  No, cancel
                </button>
              </div>
