              ...
              <div class="flex flex-row gap-5">
                ...
                <div class="flex flex-col py-5   gap-5">
                  <div class="flex flex-col w-full h-full gap-5">
                    <div class="flex flex-col w-full max-h-96 bg-red-400 h-full">
                      <div
                        className="flex items-center justify-center h-full w-full  bg-contain bg-no-repeat object-cover"
                        style={{
                    ...
                    <div class="flex flex-col w-full max-h-96 h-full">
                      <div
                        className="flex items-center justify-center h-full w-full  bg-contain bg-no-repeat object-cover"
                        style={{
                          backgroundImage: `url(${require("../images/girl.png")})`,
                    ...
                    <div class="flex flex-col w-full max-h-96 bg-red-400 h-full">
                      <div
                        className="flex items-center justify-center h-full w-full  bg-contain  bg-no-repeat "
                        style={{
