    ...
    <div class="bg-gradient-to-r lg:h-full md:h-screen from-[rgba(0,131,176,0.37)] to-[rgba(219,0,158,0.11)] lg:py-[5%] lg:pl-[9%] lg:pr-[15%] p-5">
      <div class="rounded-lg bg-white pb-[3%]">
        ...
        <div class=" flex items-center justify-center">
          ...
          <div class="w-1/2   ">
            <div class=" sm:w-[100%] px-2 lg:px-0  flex justify-center items-center">
              <p>Request a help</p>
            </div>
          </div>
        ...
        <div class="flex mt-10   ">
          ...
          <div class=" sm:block lg:flex lg:flex-row flex  w-1/2 justify-center items-center  z-50">
            <div class="border  border-black flex w-3/4 rounded-lg p-5 gap-10 flex-col">
              <div class="w-full flex flex-col gap-2 ">
                ...
                <input
                  type="text"
                  class="bg-[#EAE9E9]  h-8 rounded w-[100%]  focus:outline-none focus:border-blue-500"
                />
              </div>
              <div class="w-full flex flex-col gap-2 ">
                <div class="flex flex-row justify-between ">
                ...
                <input
                  type="text"
                  class="bg-[#EAE9E9] rounded  h-8  w-[100%]  focus:outline-none focus:border-blue-500"
                />
              </div>
              <div class="w-full flex flex-col gap-2 ">
                <div class="flex flex-row justify-between ">
                ...
                <input
                  type="text"
                  class="bg-[#EAE9E9] rounded  h-16  w-[100%]  focus:outline-none focus:border-blue-500"
                />
              </div>
            </div>
          </div>
